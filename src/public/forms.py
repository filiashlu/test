...
class vstupnitestform(Form):
    ...
    otazka1 = TextField('Hlavni mesto Ceske republiky', validators=[
        Length(min=5, max=5, message="Please use 5 characters"),
        InputRequired(message="You can't leave this empty")
    ])
    otazka2= IntegerField('Kolik je 5 * 2', validators=[
        InputRequired(message="You can't leave this empty")
    ])
    otazka3 = IntegerField('Kolik je 10 na nultou', validators=[
        InputRequired(message="You can't leave this empty")
    ])
