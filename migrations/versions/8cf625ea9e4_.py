...
Revision ID: 8cf625ea9e4
Revises: None
Create Date: 2019-09-30 11:40:11.453302

"""

# revision identifiers, used by Alembic.
revision = '8cf625ea9e4'
down_revision = None
...
def upgrade():
    ...
    op.create_table('vysledky',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('username', sa.String(length=64), nullable=False),
    sa.Column('hodnoce', sa.Float(), nullable=True),
    sa.PrimaryKeyConstraint('id', name='pk_vysledky'),
    sqlite_autoincrement=True
    )
